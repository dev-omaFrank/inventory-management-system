...
<?php $table_name = 'brands'; create_brand_table($connect, $table_name); ?>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="brandName" placeholder="Brand Name" name="brandName" autocomplete="on" 
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editBrandName" placeholder="Brand Name" name="editBrandName" autocomplete="on"
						  autocapitalize="words">
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
