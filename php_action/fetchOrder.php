 ...
 while($row = $result->fetch_array()) {
    ...
    <div class="btn-group">
      ...
      <ul class="dropdown-menu">
        <li style="display:none;" class="disabled"><a href="#" id="editOrderModalBtn" style="pointer-events: none; color: gray;"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
        
        <li style="display:none;" class="disabled"><a href="#" id="paymentOrderModalBtn" style="pointer-events: none; color: gray;"> <i class="glyphicon glyphicon-save"></i> Payment</a></li>

        <li><a type="button" onclick="printOrder('.$orderId.')"> <i class="glyphicon glyphicon-print"></i> Print </a></li>
        
        <li style="display:none;" class="disabled"><a href="#" id="removeOrderModalBtn" style="pointer-events: none; color: gray;"> <i class="glyphicon glyphicon-trash"></i> Remove</a></li>       
      </ul>
    </div>';		
