    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitUserForm" action="php_action/createUser.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="uemail" class="col-sm-3 control-label">Status: </label>
	        	
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="uemail" placeholder="status" name="ustatus" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	 
