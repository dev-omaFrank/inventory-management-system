...
$table = 'orders'; create_orders_table($connect,$table);
	...
	<div class="panel-body">
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							$productSql = "SELECT * FROM products WHERE product_active = 1 OR product_active = 2 AND product_status = 1 AND product_quantity != 0";
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total_price, orders.vat, orders.total_amount_price, orders.discount, orders.total_amount_price, orders.amount_paid, orders.amount_off, orders.payment_type, orders.payment_status,orders.payment_place FROM orders 	
