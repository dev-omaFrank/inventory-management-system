...
<?php $table_name = 'categories'; create_category_table($connect, $table_name); ?>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result" style="display: block !important;">
		      	<div class="form-group">
	      ...
	      <div class="modal-footer editCategoriesFooter" style="display: block !important;">
	        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
